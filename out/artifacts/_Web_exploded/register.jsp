		...
		$(function() {
			...
			$.validator.addMethod("ifExist",function(value,element,params){
				...
				$.ajax({
					...
					type:"POST",
					data:{"username":value},
					url:"${pageContext.request.contextPath }/UserServlet?method=isUsernameExist",
	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="registerForm"  class="form-horizontal" style="margin-top: 5px;" action="${pageContext.request.contextPath }/UserServlet?method=userRegister" method="post">
